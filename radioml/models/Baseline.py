...
class Baseline(RadioReceiver):
    """Implementation of traditional radio receiver (baseline) with the following modules:
        * Equalizer: using MMSE
    ...
    """
    def __init__(self, equalizer, modulation_scheme='QPSK', tb_depth=15, decoding_type='hard'):
